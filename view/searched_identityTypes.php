...
echo "<div class=\"row\">";
if ($AddAccess){
    echo "<div class=\"col-md-6\"><a class=\"btn icon-btn btn-success\" href=\"IdentityType.php?op=new\">";
...
?>
<form class="navbar-form" role="search" action="IdentityType.php?op=search" method="post">
